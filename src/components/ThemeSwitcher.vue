...
<!-- <div><i class="pi pi-align-left"></i> String</div>
  <div><i class="pi pi-hashtag"></i> Number</div>
  <div><i class="pi pi-check"></i> Boolean</div>
  <div><i class="pi pi-list"></i> Array</div>
  <div><i class="pi pi-calendar"></i> Date</div>
  <div><i class="pi pi-palette"></i> Color</div>
  <div><i class="pi pi-sitemap"></i> Tree</div>
  <div><i class="pi pi-table"></i> Table</div> -->
